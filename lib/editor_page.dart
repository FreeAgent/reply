...
class _EditorPageState extends State<EditorPage> {
  ...
  Widget build(BuildContext context) {
    final EmailModel emailModel = Provider.of<EmailModel>(context, listen: false);
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Expanded(child: Text(_subject, style: Theme.of(context).textTheme.titleLarge)),
          IconButton(
            onPressed: () => Navigator.of(context).pop(),
            icon: Image.asset(
    ...
    return PopupMenuButton<String>(
      ...
      itemBuilder: (BuildContext context) => <PopupMenuItem<String>>[
            PopupMenuItem<String>(
              ...
              child: Text('from.jennifer@example.com', style: Theme.of(context).textTheme.titleMedium),
            ),
            PopupMenuItem<String>(
              value: 'hey@phantom.works',
              child: Text('hey@phantom.works', style: Theme.of(context).textTheme.titleMedium),
            ),
          ],
      child: Padding(
        ...
        child: Row(
          crossAxisAlignment: CrossAxisAlignment.center,
          children: <Widget>[
            Expanded(child: Text(_senderEmail, style: Theme.of(context).textTheme.titleMedium)),
            const Icon(
            ...
            child: Wrap(
              children: <Widget>[
                Chip(
                    ...
                    label: Text(_recipient, style: Theme.of(context).textTheme.titleMedium)),
              ],
            ),
          ),
          const Icon(
